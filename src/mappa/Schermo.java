...
public class Schermo {
    ...
    // Creazione della schermata di base dell'applicazione
        ...
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                try {
                	...
                	// Creazione della schermata mediante il metodo dichiarato sopra
                    ...
                    // Istanziamento del visualizzatore della mappa, indicazione per il numero di thread utilizzati per renderizzare
                    ...
                    // Creazione dell'elemento di scelta per selezionare il tipo di mappa
                    ...
                    scelta.addActionListener(new ActionListener() {
                        ...
                        public void actionPerformed(ActionEvent e) {
                            ...
                            // Aggiornamento della mappa e reimpostazione dello zoom (purtroppo dava problemi lo zoom, ma la posizione rimane)
                            tileFactory = new DefaultTileFactory(info);
                            mapViewer.setTileFactory(tileFactory);
                            mapViewer.setZoom(7);
                            mapViewer.repaint();  
                    ...
                    // Aggiunta alla schermata del "selezionatore" del tipo di mappa e della mappa stessa
                    frame.getContentPane().add(scelta, BorderLayout.NORTH);
                    frame.getContentPane().add(mapViewer, BorderLayout.CENTER);
                    frame.setVisible(true); 
                    
                } catch (Exception e) {
                    e.printStackTrace(); // Stampa un eventuale errore a schermo (non dovrebbe accadere, però u never know)
                }
            }
        });
    }
